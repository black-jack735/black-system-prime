...
const cdtime = 5;
const prefix = "b!";
client.login("ODMxODU1MDg3MjExMTE4NjEy.YHbTaw.4QfyJ1WYrxgH2iRyC5fzJa-kXsw");
client.on("ready", () => {
  ...
  client.user.setActivity( `${prefix}help | BLACK SESTAM IS HERE | SERVERS ${client.guilds.cache.size} | Users ${client.users.cache.size} `);
  console.log(`Logined`);
});
